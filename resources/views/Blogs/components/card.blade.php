<div class="bg-gray-100 p-4 rounded shadow-md w-80">
  <img src="{{ asset('storage/blog_images/' . $blog->image) }}" alt="Blog Image" class="w-full h-40 object-cover rounded">
  {{-- @dump($blog->image). --}}
  ...
  <div class="mt-4 flex justify-between items-center">
      ...
      <!-- Delete Form -->
      <form action="{{ route('blog.delete', $blog->id) }}" method="POST" onsubmit="return confirm('Are you sure?');">
          @csrf
          @method('DELETE')
