                ...
                <div class="p-6">
                        ...
                        <div class="bg-gray-50 rounded-lg p-4">
                            <dl class="grid grid-cols-1 gap-x-4 gap-y-6 sm:grid-cols-2">
                                ...
                                <div>
                                    ...
                                    <dd class="mt-1 text-sm text-gray-900">{{ $category->subcategories->count() }}</dd>
                                </div>
                            </dl>
                        </div>
                    </div>
                    ...
                    <div>
                        <div class="flex justify-between items-center mb-4">
                            ...
                            <a href="{{ route('subcategories.create') }}?category_id={{ $category->id }}" 
                               class="bg-gamma hover:bg-gamma/70 text-white px-4 py-2 rounded-lg flex items-center gap-2 text-sm">
                        ...
                        @else
                            <div class="text-center py-8">
                                ...
                                <p class="mt-1 text-sm text-gray-500">Get started by creating a new subcategory for this category.</p>
                                <div class="mt-6">
                                    <a href="{{ route('subcategories.create') }}?category_id={{ $category->id }}" 
