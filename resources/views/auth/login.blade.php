                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="block mt-4">
                        <label for="remember_me" class="inline-flex items-center">
                            <input id="remember_me" type="checkbox" class="rounded border-gray-600 bg-gray-700 text-indigo-500 shadow-sm focus:ring-indigo-500" name="remember">
                    ...
                    <div class="flex items-center justify-between mt-4">
                        ...
                        <x-primary-button class="ms-3 bg-indigo-600 hover:bg-indigo-700 focus:ring-indigo-500 text-white font-semibold py-2 px-4 rounded-lg">
                            {{ __('Log in') }}
                        </x-primary-button>
                    </div>
                </form>
